...
REST API使用标准 HTTP 方法（GET、POST、PUT、DELETE）与 URI 表示的资源进行交互。它是无状态的，需要完整的请求信息，使用 HTTP 状态码，通常通过 JSON/XML 进行通信。
## 架构属性

![](https://r2.matsumae.top/obsidian/{fileName}.{extName}/20260516192056976.webp)

现代互联网架构
![](https://r2.matsumae.top/obsidian/{fileName}.{extName}/20260516193300464.webp)