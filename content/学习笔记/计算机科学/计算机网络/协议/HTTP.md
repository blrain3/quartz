...
![通过 HTTP 的客户/服务器连接](https://developer.mozilla.org/en-US/docs/Learn_web_development/Howto/Web_mechanics/What_is_a_web_server/web-server.svg)

比如说点开视频网站，浏览器发送"给我视频界面"的请求，服务器返回 HTML、图片、视频数据。
...
其中 `GET` 表示要获取的东西，`HTTP/1.1` 表示使用 HTTP 1.1 协议。
...
具体状态码可参考 [MDN 文档](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Reference/Status)。